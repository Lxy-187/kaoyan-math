      ...
      },
      {
        ...
        topics: [
          { id: 'definition',   title: '导数定义与可导性判定',
            file: 'content/calculus/02-derivative/definition.js' },
          { id: 'techniques',   title: '求导技巧（复合 / 隐函数 / 参数方程）',
            file: 'content/calculus/02-derivative/techniques.js' },
          { id: 'high-order',   title: '高阶导数与莱布尼茨公式',
            file: 'content/calculus/02-derivative/high-order.js' },
          { id: 'differential', title: '微分与近似计算',
            file: 'content/calculus/02-derivative/differential.js' },
        ],
      },
      {
        ...
        topics: [
          ...
          { id: 'inequality',    title: '不等式的证明',
            file: 'content/calculus/03-derivative-app/inequality.js' },
          { id: 'roots',         title: '零点个数与方程的根',
            file: 'content/calculus/03-derivative-app/roots.js' },
          { id: 'monotone',      title: '单调性 / 极值 / 最值',
            file: 'content/calculus/03-derivative-app/monotone.js' },
          { id: 'convexity',     title: '凹凸性 / 拐点 / 渐近线',
            file: 'content/calculus/03-derivative-app/convexity.js' },
          { id: 'curvature',     title: '曲率与相关变化率',
            file: 'content/calculus/03-derivative-app/curvature.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'substitution', title: '换元法（凑微分 / 三角代换）',
            file: 'content/calculus/04-indefinite/substitution.js' },
          { id: 'by-parts',     title: '分部积分法',
            file: 'content/calculus/04-indefinite/by-parts.js' },
          { id: 'rational',     title: '有理函数与三角有理式',
            file: 'content/calculus/04-indefinite/rational.js' },
          { id: 'toolbox',      title: '常见积分类型速查',
            file: 'content/calculus/04-indefinite/toolbox.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'properties',   title: '定积分的性质与计算',
            file: 'content/calculus/05-definite/properties.js' },
          { id: 'variable-limit', title: '变限积分函数',
            file: 'content/calculus/05-definite/variable-limit.js' },
          { id: 'integral-proof', title: '积分不等式与积分证明题',
            file: 'content/calculus/05-definite/integral-proof.js' },
          { id: 'improper',     title: '反常积分及其敛散性',
            file: 'content/calculus/05-definite/improper.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'area-volume', title: '面积、体积与弧长',
            file: 'content/calculus/06-definite-app/area-volume.js' },
          { id: 'physics',     title: '物理应用（压力 / 功 / 质心）',
            file: 'content/calculus/06-definite-app/physics.js' },
          { id: 'micro-element', title: '微元法的建模思路',
            file: 'content/calculus/06-definite-app/micro-element.js' },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          { id: 'concepts',      title: '偏导、全微分与可微性',
            file: 'content/calculus/09-multi-derivative/concepts.js' },
          { id: 'chain-rule',    title: '复合与隐函数求导',
            file: 'content/calculus/09-multi-derivative/chain-rule.js' },
      ...
      },
      {
        ...
        topics: [
          { id: 'double',        title: '二重积分：换序与坐标选择',
            file: 'content/calculus/10-multi-integral/double.js' },
          ...
          { id: 'symmetry',      title: '对称性与轮换对称性',
            file: 'content/calculus/10-multi-integral/symmetry.js' },
          { id: 'integral-app',  title: '重积分的应用',
            file: 'content/calculus/10-multi-integral/integral-app.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'line-integral',    title: '第一类 / 第二类曲线积分',
            file: 'content/calculus/11-line-surface/line-integral.js' },
          ...
          { id: 'second-kind-surface', title: '第二类曲面积分',
            file: 'content/calculus/11-line-surface/second-kind-surface.js' },
          { id: 'gauss-stokes',     title: '高斯公式与斯托克斯公式',
            file: 'content/calculus/11-line-surface/gauss-stokes.js' },
          { id: 'field-theory',     title: '散度、旋度与场论初步',
            file: 'content/calculus/11-line-surface/field-theory.js' },
        ],
      },
      {
        ...
        topics: [
          ...
          { id: 'expansion',     title: '函数展开成幂级数',
            file: 'content/calculus/12-series/expansion.js' },
          { id: 'fourier',       title: '傅里叶级数',
            file: 'content/calculus/12-series/fourier.js' },
      ...
      },
      {
        ...
        topics: [
          { id: 'basics',        title: '特征值特征向量的求法与性质',
            file: 'content/linear-algebra/05-eigen/basics.js' },
          ...
          { id: 'applications',  title: '由特征值反求矩阵 / 求方幂',
            file: 'content/linear-algebra/05-eigen/applications.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'standard',     title: '化标准形（配方法 / 正交变换）',
            file: 'content/linear-algebra/06-quadratic/standard.js' },
          { id: 'definite',     title: '正定性判定',
            file: 'content/linear-algebra/06-quadratic/definite.js' },
          { id: 'congruence',   title: '合同、惯性定理与规范形',
            file: 'content/linear-algebra/06-quadratic/congruence.js' },
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        topics: [
          { id: 'operations',   title: '事件关系与概率计算',
            file: 'content/probability/01-events/operations.js' },
          { id: 'conditional',  title: '条件概率、全概率与贝叶斯',
            file: 'content/probability/01-events/conditional.js' },
          { id: 'independence', title: '独立性与伯努利试验',
            file: 'content/probability/01-events/independence.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'distributions', title: '常见分布及其背景',
            file: 'content/probability/02-random-var/distributions.js' },
          { id: 'cdf-pdf',       title: '分布函数与密度函数',
            file: 'content/probability/02-random-var/cdf-pdf.js' },
          { id: 'function-of-rv', title: '随机变量函数的分布',
            file: 'content/probability/02-random-var/function-of-rv.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'joint',        title: '联合分布、边缘分布与条件分布',
            file: 'content/probability/03-multi-random-var/joint.js' },
          { id: 'independence', title: '独立性判定',
            file: 'content/probability/03-multi-random-var/independence.js' },
          { id: 'function-2d',  title: '二维随机变量函数的分布',
            file: 'content/probability/03-multi-random-var/function-2d.js' },
          { id: 'normal-2d',    title: '二维正态分布',
            file: 'content/probability/03-multi-random-var/normal-2d.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'expectation', title: '期望与方差的计算',
            file: 'content/probability/04-moments/expectation.js' },
          { id: 'covariance',  title: '协方差与相关系数',
            file: 'content/probability/04-moments/covariance.js' },
          { id: 'tricks',      title: '数字特征的常用技巧',
            file: 'content/probability/04-moments/tricks.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'lln', title: '切比雪夫不等式与大数定律',
            file: 'content/probability/05-lln-clt/lln.js' },
          { id: 'clt', title: '中心极限定理的应用',
            file: 'content/probability/05-lln-clt/clt.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'sampling',      title: '总体、样本与统计量',
            file: 'content/probability/06-statistics/sampling.js' },
          { id: 'distributions', title: '三大抽样分布与正态总体',
            file: 'content/probability/06-statistics/distributions.js' },
        ],
      },
      {
        ...
        topics: [
          { id: 'point',        title: '矩估计与最大似然估计',
            file: 'content/probability/07-estimation/point.js' },
          { id: 'evaluation',   title: '估计量的评价（无偏 / 有效 / 一致）',
            file: 'content/probability/07-estimation/evaluation.js' },
          { id: 'interval',     title: '区间估计',
            file: 'content/probability/07-estimation/interval.js' },
